...
$(document).ready(init);
},{"./config":3,"./gesture":4,"./page":5,"jquery":1}],3:[function(require,module,exports){
/**
...
},{"./util":6,"jquery":1}],5:[function(require,module,exports){
var $ = require('jquery');
var util = require('./util');
...
},{"./util":6,"jquery":1}],6:[function(require,module,exports){
module.exports = {
    /**
     * 判断是否支持 touch 事件
     * @returns {boolean|*}
